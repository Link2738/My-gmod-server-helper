...
class GMAExtractorGUI:
    ...
    def setup_widgets(self):
        ...
        self.write_bodygroups_chk = tk.Checkbutton(self.root, text="Write bodygroup data to Lua", variable=self.write_bodygroups)
        ...
        def update_bodygroup_modifications_state(*args):
        ...
        self.write_bodygroups.trace_add('write', update_bodygroup_modifications_state)
        update_bodygroup_modifications_state()
        # Removed skip .bsp files checkbox
            ...
            if input_type == 'File':
                ...
                for mdl_path in mdl_files:
                    ...
                    if qc_path:
                        ...
                        # Only write bodygroups if checkbox is checked
                        if write_bodygroups:
                        ...
                        for gma_file in gma_files:
                            ...
                            for mdl_path in mdl_files:
                                ...
                                if qc_path:
                                    bodygroups = parse_qc_bodygroups(qc_path)
                                    if self.write_bodygroups.get():
                                        write_pointshop_lua(mdl_path, bodygroups, output_dir, log_callback)
                                    else:
                                        write_pointshop_lua(mdl_path, [], output_dir, log_callback)
                    else:
